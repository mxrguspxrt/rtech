...
set(eigen_conversions_SOURCE_PREFIX /home/dte/Desktop/rtech/src/eigen_conversions)
set(eigen_conversions_DEVEL_PREFIX /home/dte/Desktop/rtech/devel)
...
if(NOT "/home/dte/Desktop/rtech/src/eigen_conversions/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include " STREQUAL " ")
  set(eigen_conversions_INCLUDE_DIRS "")
  set(_include_dirs "/home/dte/Desktop/rtech/src/eigen_conversions/include;/usr/include/eigen3;/usr/share/orocos_kdl/cmake/../../../include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'eigen_conversions' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/dte/Desktop/rtech/src/eigen_conversions/${idir}'.  ${_report}")
    endif()
